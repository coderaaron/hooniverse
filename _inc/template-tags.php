...
if ( ! function_exists( 'hooniverse_paging_nav' ) ) :
	...
	<nav class="paging-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"><?php previous_posts_link( __( '<span class="screen-reader-text">Previous Page</span>', 'hooniverse' ) ); ?></div>
			<?php endif; ?>
			...
			<div class="nav-next"><?php next_posts_link( __( '<span class="screen-reader-text">Next Page</span>', 'hooniverse' ) ); ?></div>
			<?php endif; ?>
 ...
 */
function hooniverse_get_sidebar_nav() {
	$sidebar = false;
