 ...
 */
class hooniverse_main_menu extends Walker_Page {
    public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
        ...
        if ( '' === $page->post_title ) {
            $page->post_title = sprintf( __( '#%d (no title)', 'hooniverse' ), $page->ID );
        }

		$submenubutton = '';

		if ( strpos( $css_classes, 'menu-item-has-children' ) ) {
			$submenubutton = '<button class="sub-menu-toggle mobile-only">' . $page->post_title . '</button>';
		}
