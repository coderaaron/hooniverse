...
add_image_size( 'featured-img-hero-sm', 960, 960 );
add_image_size( 'featured-img-hero', 1920, 1920 );
add_image_size( 'featured-img-hero-1_5x', 2880, 1440 );
add_image_size( 'featured-img-hero-2x', 3820, 1920 );
